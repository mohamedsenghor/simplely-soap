...
public class PaymentAsserts {
    ...
    public static void assertPaymentUpdatableFieldsEquals(Payment expected, Payment actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getNumberReceive()).as("check numberReceive").isEqualTo(expected.getNumberReceive()))
    ...
    public static void assertPaymentUpdatableRelationshipsEquals(Payment expected, Payment actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getInitiator()).as("check initiator").isEqualTo(expected.getInitiator()));
    }
}
