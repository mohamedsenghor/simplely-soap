...
import dev.black.simplelysoap.repository.ClientRepository;
import dev.black.simplelysoap.service.dto.ClientDTO;
import dev.black.simplelysoap.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    private static final Long DEFAULT_NUMERO_TEL = 1L;
    private static final Long UPDATED_NUMERO_TEL = 2L;

    private static final Long DEFAULT_SOLDE = 0L;
    private static final Long UPDATED_SOLDE = 1L;
    ...
    public static Client createEntity() {
        return new Client().numeroTel(DEFAULT_NUMERO_TEL).solde(DEFAULT_SOLDE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().numeroTel(UPDATED_NUMERO_TEL).solde(UPDATED_SOLDE);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].numeroTel").value(hasItem(DEFAULT_NUMERO_TEL.intValue())))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.numeroTel").value(DEFAULT_NUMERO_TEL.intValue()))
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.numeroTel(UPDATED_NUMERO_TEL).solde(UPDATED_SOLDE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.solde(UPDATED_SOLDE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.numeroTel(UPDATED_NUMERO_TEL).solde(UPDATED_SOLDE);
