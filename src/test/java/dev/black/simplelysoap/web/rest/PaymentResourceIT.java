...
import dev.black.simplelysoap.repository.PaymentRepository;
import dev.black.simplelysoap.service.PaymentService;
import dev.black.simplelysoap.service.dto.PaymentDTO;
import dev.black.simplelysoap.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    private static final Long DEFAULT_NUMBER_RECEIVE = 1L;
    private static final Long UPDATED_NUMBER_RECEIVE = 2L;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment()
            .numberReceive(DEFAULT_NUMBER_RECEIVE)
            .amountSent(DEFAULT_AMOUNT_SENT)
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment updatedPayment = new Payment()
            .numberReceive(UPDATED_NUMBER_RECEIVE)
            .amountSent(UPDATED_AMOUNT_SENT)
        ...
        updatedPayment.setInitiator(client);
    ...
    @Test
    @Transactional
    void checkNumberReceiveIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        payment.setNumberReceive(null);
    ...
    void checkDateTransactionIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        payment.setDateTransaction(null);
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberReceive").value(hasItem(DEFAULT_NUMBER_RECEIVE.intValue())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.numberReceive").value(DEFAULT_NUMBER_RECEIVE.intValue()))
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.numberReceive(UPDATED_NUMBER_RECEIVE).amountSent(UPDATED_AMOUNT_SENT).dateTransaction(UPDATED_DATE_TRANSACTION);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.numberReceive(UPDATED_NUMBER_RECEIVE).amountSent(UPDATED_AMOUNT_SENT);
