...
/**
 * Service Implementation for managing {@link dev.black.simplelysoap.domain.Client}.
 */
@Service
@Transactional
public class ClientService {
    ...
    public Optional<ClientDTO> findOneByNumeroTel(long tel) {
        return clientRepository.findByNumeroTel(tel).map(clientMapper::toDto);
    }
}
